...
const Card = ({item}) => {
 ...
 useEffect(()=>{
  ...
  return (  
    <>
      <div onMouseEnter={()=>{setThumbnailButton(true)}} onMouseLeave={()=>{setThumbnailButton(false)}}  className="w-full max-w-sm bg-[214344] border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
